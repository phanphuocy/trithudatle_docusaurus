...
2. Hiệu suất không phải vấn đề đáng lo ngại.

## Tiến độ đạt được

### 1. Homepage cơ bản

Trang chủ cơ bản hoàn thiện layout, có smooth scrolling và transition giữa các section cơ bản. Để nâng cao thì em sẽ tìm hiểu thêm về hiệu ứng animation phù hợp phong cách của TTDL. Animation hiện tại là để test hiệu suất của các thư viện thêm vào.
...
Những trang này cần có nội dung bên trong, hiện tại hình ảnh đang để placeholder. Do đó sắp tới em sẽ [cần hình ảnh](#1-hình-ảnh).
...
## Tạm an tâm về hiệu suất

### Tối ưu performance

Mục tiêu của giai đoạn phát triển ban đầu là tối ưu hiệu suất của các trang. Khi hiệu suất tốt thì mới thêm các hiệu ứng để gia tăng trải nghiệm.

Dưới đây là bảng audit Lighthouse của các trang đang có. Các chỉ số đều >95 (trừ SEO, lỗi thiếu meta description).
